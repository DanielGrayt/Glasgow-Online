(function (root, factory) {
    ...
    var defaults = {
		...
		navDropdownId:				"nav_dropdown",
        navDropdownToggle:          "nav__dropdown-toggle", // class used for the dropdown toggle.
        navDropdownLabel:           "more", // Text that is used for the dropdown toggle.
        navDropdownBreakpointLabel: "menu", //button label for navDropdownToggle when the breakPoint is reached.
        breakPoint:                 859, //amount of pixels when all menu items should be moved to dropdown to simulate a mobile menu
        throttleDelay:              50, // this will throttle the calculating logic on resize because i'm a responsible dev.
        offsetPixels:               1, // increase to decrease the time it takes to move an item.
    ...
    var prepareHtml = function (_this, settings) {
		...
		navDropdown.setAttribute('id', settings.navDropdownId);
    ...
    var listeners = function (_this, settings) {
        ...
        document.addEventListener("click", function (event) {
            if (/*!getClosest(event.target, settings.navDropdown) && event.target !== _this.querySelector(navDropdownToggle) || */ /*!$(event.target).hasClass('nav__dropdown-toggle') || $(event.target).hasClass('nav__dropdown'))*/
			!$(event.target).parents('.nav__dropdown-wrapper').length > 0) {
                _this.querySelector(navDropdown).classList.remove("show");
